...
import br.edu.ifrn.chat.service.ClientService;
...
public class ClientFrame extends javax.swing.JFrame {
    ...
    private void connect() throws HeadlessException {
        do {
            this.IP_Servidor = showInputDialog(null, "Informe o IP do Servidor: ", "", PLAIN_MESSAGE);
            this.Porta_Servidor = Integer.parseInt(showInputDialog(null, "Informe a Porta do Servidor: ", "", PLAIN_MESSAGE)); 
            this.nickName = showInputDialog(null, "Entre com seu nick-name: ", "", PLAIN_MESSAGE);
        } while (this.nickName.isEmpty() && this.IP_Servidor.isEmpty() && this.Porta_Servidor==0);
